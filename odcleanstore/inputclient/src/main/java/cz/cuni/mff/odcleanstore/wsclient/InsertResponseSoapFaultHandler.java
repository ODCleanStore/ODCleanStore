...
class InsertResponseSoapFaultHandler extends DefaultHandler {
     ...
     */
    private enum State {
        ISONPATH, ISONID, ISONMESSAGE, ISONMOREINFO, ISONOTHER
    }
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
        ...
        case 4:
            ...
            break;
        case 5:
            if (path.peek().getState() == State.ISONPATH) {
    ...
    public void characters(char[] ch, int start, int length) throws SAXException {
        State state = path.peek().getState();
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        Node node = path.pop();
        level--;
        if (!uri.equals(node.getUri()) || !localName.equals(node.getLocalName())) {
            throw new SAXException();
        }
    }
}
