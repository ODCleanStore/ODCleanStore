...
public class MainConflictResolutionPrototype {
    ...
    private static void test1(AggregationType aggregationType, boolean print) throws ODCleanStoreException {
        ...
        graph.add(createQuad(subject_1_1, predicate_1, object_1_1_a_alias, createURI("ng_1_1_a_alias")));
