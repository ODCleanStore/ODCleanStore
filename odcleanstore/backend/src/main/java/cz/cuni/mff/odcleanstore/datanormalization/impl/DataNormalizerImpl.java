...
public class DataNormalizerImpl implements DataNormalizer, Serializable {
	 ...
	 * @author Jakub Daniel
	 */
	public class TripleModificationImpl implements TripleModification {
		...
		public TripleModificationImpl(String s, String p, String o) {
			this.subject = s;
			this.predicate = p;
			this.object = o;
		}
	 ...
	 * @author Jakub Daniel
	 */
	public class RuleModificationImpl implements RuleModification {
		private static final long serialVersionUID = 1L;
	...
	public class GraphModificationImpl implements GraphModification {
        ...
        public void addInsertion (DataNormalizationRule rule, String s, String p, String o) {
			if (modifications.containsKey(rule)) {
				 ...
				 */
				RuleModification subModifications = new RuleModificationImpl();
	...
	public GraphModification getGraphModifications(final String graphName,
		...
		GraphModification modifications = new GraphModificationImpl();
