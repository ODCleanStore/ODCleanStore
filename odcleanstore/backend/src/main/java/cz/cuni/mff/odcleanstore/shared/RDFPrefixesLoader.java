...
public class RDFPrefixesLoader {
	 ...
	 * @throws ConnectionException when connection could not be estabilished
	 * @throws QueryException when query failed to execute
	 * @throws SQLException when query results could not be obtained
	 */
	public static List<RDFprefix> loadPrefixes(SparqlEndpoint endpoint) 
			throws ConnectionException, QueryException, SQLException {
