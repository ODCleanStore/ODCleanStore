...
public class _SubjectComparator implements Comparator<Statement> {
    private static final LexicalValueComparator COMPARATOR = new LexicalValueComparator();
    private static Comparator<Statement> instance = new _SubjectComparator();
    ...
    public int compare(Statement s1, Statement s2) {
        return COMPARATOR.compare(s1.getSubject(), s2.getSubject());
    }
}
