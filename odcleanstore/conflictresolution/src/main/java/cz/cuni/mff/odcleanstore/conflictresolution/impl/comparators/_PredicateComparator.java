...
public class _PredicateComparator implements Comparator<Statement> {
    private static final LexicalValueComparator COMPARATOR = new LexicalValueComparator();
    private static Comparator<Statement> instance = new _PredicateComparator();
    ...
    public int compare(Statement s1, Statement s2) {
        return COMPARATOR.compare(s1.getPredicate(), s2.getPredicate());
    }
}
