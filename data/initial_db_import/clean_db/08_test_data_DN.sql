...
VALUES (0, (SELECT id FROM DB.ODCLEANSTORE.DN_RULES_GROUPS WHERE label = 'test group'), 'test rule A', n'');

INSERT INTO DB.ODCLEANSTORE.DN_RULES_UNCOMMITTED (id, groupId, label, description) 
VALUES (1, (SELECT id FROM DB.ODCLEANSTORE.DN_RULES_GROUPS WHERE label = 'test group'), 'test rule B', n'');
