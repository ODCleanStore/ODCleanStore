...
DROP TABLE DB.FRONTEND.EL_RULES_TO_DOMAINS_RESTRICTIONS;
DROP TABLE DB.FRONTEND.EL_RULES;
...
/*
	...
	===========================================================================
*/
CREATE TABLE DB.FRONTEND.EL_RULES
(
	id INTEGER NOT NULL IDENTITY PRIMARY KEY,
...
CREATE TABLE DB.FRONTEND.EL_RULES_TO_DOMAINS_RESTRICTIONS
(
	ruleId INTEGER NOT NULL,
	domainId INTEGER NOT NULL,
	
	PRIMARY KEY (ruleId, domainId),
	FOREIGN KEY (ruleId) REFERENCES DB.FRONTEND.EL_RULES(id),
