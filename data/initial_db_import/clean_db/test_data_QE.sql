INSERT INTO DB.FRONTEND.CR_PROPERTIES (property, multivalue, aggregationTypeId) VALUES ('http://www.w3.org/2003/01/geo/wgs84_pos#long', NULL, (SELECT id FROM DB.FRONTEND.CR_AGGREGATION_TYPES WHERE label = 'AVG'));
