...
\label{sec:transformerManagement}
	...
	\begin{itemize}
		...
		Description of what the purpose of the {transformer} is.
		
		\item \textbf{required} JAR path
		
		Path to a Java Archive containing the {transformer} declaration.
		
		\item \textbf{required} Full classname
		
		Name of the class implementing the {transformer}.
	\end{itemize}
