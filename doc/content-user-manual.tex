...
\begin{enumerate}
	\item[] \subsection*{Prepare transformer}
	...
	\item[]\item[] \subsection*{Prepare rules for standard transformer}
	...
	\item[]\item[] \subsection*{Prepare pipeline}
	...
	\emph{If there is no option then go back to the} \textbf{\hyperref[sec:prepareTransformer]{Prepare transformer}} \empth{section}
	...
	\item[]\item[] If you added a standard transformer
