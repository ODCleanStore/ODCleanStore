...
\paragraph{Important note:} Any changes done in this section need to be commited to ever take effect. To do so, please, click the "Commit settings" button.
...
\begin{enumerate}
	...
	\item Click "Add a new transformer"
	...
	\item Click "Add a new group"
	\item Fill in necessary information and submit it
	\item Click "Detail" in the row of the group created in the previous step
	\item Click "Add a new rule", fill in its description and submit
	\item Click "Detail" in the row of the rule created in the previous step
	\item Click "Add a new rule component"
