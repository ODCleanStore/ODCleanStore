...
%TODO co to je, co to dělá, odkaz na sub:qualityAssessment

\subsubsection{Quality Aggregator}
%% TODO coto je, co to dělá

\subsubsection{Data Normalization}
%TODO co to je, co to dělá, odkaz na sub:dataNormalization

\subsubsection{Linker}
%TODO co to je, co to dělá, odkaz na sub:objectIdentification
...
The URIs generated in place of blank nodes have form \varcode{prefix}\varcode{randomUUID}-\varcode{node number}. The prefix may be given in \code{Configuration} field of the transformer instance as \quot{\code{uriPrefix=}\varcode{URI prefix}} on a single line. If the prefix is not specified, the concatenation of \code{input_ws.named_graphs_prefix} configuration option value and \quot{getResource} is used as the default value.
...
\begin{enumerate}[resume]
	...
	\item Click \quot{Detail} in the row of the pipeline created in the previous step
	...
	\item Click \quot{Detail} in the row of the transformer
