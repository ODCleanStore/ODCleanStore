...
While the \code{QualityAggregator} is a trivial extension of \code{Transformer} the \code{QualityAssessor} provides additional \code{debugRules} method

apart of them \code{QualityAssessmentRulesModel} provides interface for rule generation from ontologies

\subsection{Implementation}

\subsection*{Quality Assessment Rules}
...
\subsection*{Quality Assessor}

implemented by class \code{QualityAssessorImpl}
...
\subsection*{Quality Aggregator}

implemented by class \code{QualityAggregatorImpl}
