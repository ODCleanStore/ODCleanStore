...
\begin{itemize}
	\code{DataNormalizationBooleanRule}
	\code{DataNormalizationDateRule}
	\code{DataNormalizationStringRule}
	\code{DataNormalizationNonNegativeIntegerRule}
	\code{DataNormalizationNonPositiveIntegerRule}
	\code{DataNormalizationIntegerRule}
	\code{DataNormalizationNumberRule}
\end{itemize}
