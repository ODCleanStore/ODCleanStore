...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\refusermanual}{User Manual}
\newcommand{\refadmimanual}{Administrator's \& Installation Manual}
\newcommand{\refprogrammersguide}{Programmer's Guide}
...
{
	\begin{table}[!h]
		\begin{tabular}{>{\textbf\bgroup}l<{\egroup}p{14cm}}
			#1
		\end{tabular}
	\end{table}
}
...
{
	\begin{table}[!h]
		\begin{tabular}{>{\textbf\bgroup}l<{\egroup}p{3cm}p{11cm}}
			#1
		\end{tabular}
	\end{table}
}
