...
After a clean installation, \FE contains a single administrator account with username \quot{adm} and password \quot{adm}. For security reasons, \textbf{make sure to change the default credentials}.
