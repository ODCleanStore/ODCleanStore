...
\begin{verbatim}
  odcs-installer.bat
\end{verbatim}
on Windows. This should start the installer. If the Virtuoso's \code{isql} executable is not on system PATH for any reason, you can pass the full path to the installer manually:
\begin{verbatim}
